...
### Improved Abjuration
Beginning at 10th level, when you cast an abjuration spell that requires you to make an ability check as a part of casting that spell (as in _counterspell_ and _dispel magic_), you add your proficiency bonus to that ability check.
...
### Shapechanger
At 10th level, you add the _polymorph_ spell to your spellbook, if it is not there already. You can cast _polymorph_ without expending a spell slot. When you do so, you can target only yourself and transform into a beast whose challenge rating is 1 or lower.
